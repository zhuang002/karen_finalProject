def render_wizard_page(page_key):
    page = wizard_pages[page_key]
    tp = page["type"]
    if tp == "Select" or tp == "Menu":
        return render_template("select_page.html", page=page)
    elif tp == "Input":
        return render_template("input_page.html", page=page)
