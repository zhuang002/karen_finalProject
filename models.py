...
class UpperFloor:
    def __init__(self, bedrooms: list[Room] = None, bathrooms: list[Bathroom] = None, closets: list[Room] = None):
...
class MainFloor:
    def __init__(self, foyer: Foyer, dinning_room: Room, family_room: Room, bathroom: Bathroom,
                 ...
                 stair: Stair = None, hallway: Room = None):
        self.foyer = foyer
...
class Basement:
    def __init__(self, rooms: list[Room], bathrooms: list[Room]):
        self.rooms = rooms
        self.bathrooms = bathrooms
